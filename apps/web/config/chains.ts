...
export const CHAIN_PARAMS: Record<Network, ChainParams> = {
  alfajores: {
    ...
    rpcUrls: ['https://celo-mainnet.g.allthatnode.com/full/evm/072b86754d2543c6b9ca68d5bbee0ae9'],
  ...
  dango: {
    ...
    rpcUrls: ['https://ethereum-sepolia.g.allthatnode.com/full/evm/072b86754d2543c6b9ca68d5bbee0ae9'],
